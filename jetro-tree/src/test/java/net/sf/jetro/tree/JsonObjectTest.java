...
public class JsonObjectTest {
	...
	public void shouldDeepCopyWithPaths() {
		...
		verifyElementFrom(deepCopied).at(JsonPath.compile("$.objectKey.stringKey")).equals(new JsonString("value"));
	}
	...
	public void shouldRemoveElementOnlyAtFromObject() {
		...
		boolean removed = firstObject.removeElementAt(JsonPath.compile("$.thirdObject.jsonBoolean"));
		assertTrue(removed);
	...
	public void shouldRemoveElementOnlyAtFromInnerObject() {
		...
		JsonPath booleanPath = JsonPath.compile("$.secondObject.thirdObject" + ".fourthObject.jsonBoolean");
		JsonPath stringPath = JsonPath.compile("$.thirdObject.fourthObject.jsonString");

		verifyElementFrom(firstObject).at(booleanPath).is(jsonBoolean);
		verifyElementFrom(firstObject).at(stringPath).is(jsonString);

		boolean removed = firstObject.removeElementAt(JsonPath.compile("$.thirdObject.fourthObject.jsonBoolean"));
		assertTrue(removed);
	...
	public void shouldRemoveElementOnlyAtFromFlatSameObjectDuplicate() {
		...
		boolean removed = outerObject.removeElementAt(JsonPath.compile("$.innerObject2.jsonBoolean"));
		assertTrue(removed);
	...
	@Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "A non-null path to remove the element at must be specified")
	public void shouldThrowForRemoveElementAtNullPath() {
		new JsonObject().removeElementAt(null);
	}

	@Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Cannot remove JSON tree root")
	public void shouldThrowForRemoveElementAtRootPath() {
		new JsonObject().removeElementAt(new JsonPath());
	}

	@Test(expectedExceptions = IllegalStateException.class, expectedExceptionsMessageRegExp = "removeElementAt can only be called on the JSON tree root.")
	...
	public void shouldNotAddElementAtToPrimitive() {
		...
		boolean added = jsonObject.addElementAt(JsonPath.compile("$.jsonBoolean.jsonString"), new JsonString());
		assertFalse(added);
	}
	...
	public void shouldNotAddElementAtToArrayWithInvalidIndex() {
		...
		boolean added = jsonObject.addElementAt(JsonPath.compile("$.jsonArray[1]"), new JsonBoolean());
		assertFalse(added);

		assertTrue(jsonArray.isEmpty());
	}

	@Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "A non-null path to add the element at must be specified")
	public void shouldThrowForAddElementAtNullPath() {
		new JsonObject().addElementAt(null, new JsonBoolean());
	}

	@Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "A non-null element to be added must be specified")
	public void shouldThrowForAddElementAtNullElement() {
		new JsonObject().addElementAt(new JsonPath(), (JsonType) null);
	}

	@Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Cannot add JSON tree root")
	public void shouldThrowForAddElementAtRootPath() {
		new JsonObject().addElementAt(new JsonPath(), new JsonBoolean());
	}

	@Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "A non-null path to replace the element at must be specified")
	public void shouldThrowForReplaceElementAtNullPath() {
		new JsonObject().replaceElementAt(null, new JsonBoolean());
	}

	@Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "A non-null element to be inserted must be specified")
	public void shouldThrowForReplaceElementAtNullElement() {
		new JsonObject().replaceElementAt(new JsonPath(), (JsonType) null);
	}

	@Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Cannot replace JSON tree root")
	...
	public void shouldReplaceElementAtInArray() {
		...
		Optional<JsonType> replacedElement = jsonObject.replaceElementAt(replacePath, jsonBoolean);
	...
	public void shouldReplaceElementOnlyAtInObject() {
		...
		Optional<JsonType> replacedElement = outerObject.replaceElementAt(replacePath, jsonBoolean);
	...
	public void shouldNotReplaceElementAtWithNonexistingElement() {
		...
		assertFalse(jsonObject.replaceElementAt(JsonPath.compile("$.jsonArray[0]"), new JsonBoolean()).isPresent());
	}
	...
	public void shouldNotReplaceElementAtWithNonexistingProperty() {
		...
		assertFalse(jsonObject.replaceElementAt(JsonPath.compile("$.property"), new JsonBoolean()).isPresent());
	}
	...
	public void shouldNotReplaceElementAtWithNonexistingPath() {
		...
		assertFalse(
				jsonObject.replaceElementAt(JsonPath.compile("$.property.property"), new JsonBoolean()).isPresent());
	}
	...
	public void shouldReplaceElementOnlyAtInInnerArray() {
		...
		Optional<JsonType> replaced = jsonObject.replaceElementAt(replacePath, jsonNumber);
	...
	public void shouldReplaceElementOnlyAtInInnerObject() {
		...
		Optional<JsonType> replaced = rootObject.replaceElementAt(replacePath, jsonNumber);
	...
	@Test
	public void shouldBeEqualAfterPropertyValueChange() {
		JsonObject actualInnerObject = new JsonObject();
		actualInnerObject.add(new JsonProperty("string", "string2"));

		JsonObject actual = new JsonObject();
		actual.add(new JsonProperty("innerObject", actualInnerObject));

		actual.recalculateTreePaths();

		JsonObject expectedInnerObject = new JsonObject();
		expectedInnerObject.add(new JsonProperty("string", "string"));

		JsonObject expected = new JsonObject();
		expected.add(new JsonProperty("innerObject", expectedInnerObject));
