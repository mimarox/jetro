 ...
 * intended only to save allocations.
 * 
 * <p>
...
final class StringPool {
	/**
	 * The maximum length of strings to add to the pool. Strings longer than
	 * this don't benefit from pooling because we spend more time on pooling
	 * than we save on garbage collection.
	 */
